const fs = require('fs');
let html = fs.readFileSync('clean_index.html', 'utf8');
...
// Clean up duplicate vars from the old version
...
// Duplicate HTML form blocks fix
...
console.log("Fully restored and patched from clean file!");
